        ...
        <div class="container">
            ...
            <div class="content">
                <div style="text-align: center;">
                    <span class="status-badge">Created Successfully</span>
                </div>

                <h2 class="greeting">Hello {{ $booking->user->name }},</h2>
                <p class="message-body">
                    Thank you for choosing TechPickly Premium Logistics. Your cargo booking has been successfully created. Below are the details of your cargo request.
                </p>
