...
@section('title', 'Return & Refund Policy - ' . settings('app_name', config('app.name')))
@section('meta_description', 'Read our Return and Refund Policy regarding cargo insurance, missing item claims, or package returns.')
            ...
            <div class="mb-10 pb-6 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <span class="px-2.5 py-1 text-[10px] font-extrabold tracking-widest text-[#ED1C24] uppercase bg-red-500/10 rounded-full border border-red-500/20 inline-block mb-2">
                        Cargo Claims & Returns
                    </span>
                    <h1 class="text-3xl sm:text-4xl font-extrabold text-[#262262] tracking-tight">Return & Refund Policy</h1>
                </div>
